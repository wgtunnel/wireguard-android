...
public class Statistics {
     ...
     */
    void add(final Key key, final String resolvedEndpoint, final long rxBytes, final long txBytes, final long latestHandshake) {
        stats.put(key, new PeerStats(rxBytes, txBytes, latestHandshake, resolvedEndpoint));
